...
export default function MembershipAdminPage() {
  ...
  const { isSignedIn, hasPermission, isAdmin } = useAuth();
  ...
  const canManageMembership = hasPermission('membership.manage') || isAdmin;
  ...
  }, [filter, page, canManageMembership]);
  ...
  if (!isSignedIn) {
    return (
      <div className="text-center py-16">
        ...
        <p className="text-white/60">You need to be signed in to access this page.</p>
      </div>
    );
  }
