            ...
            <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
                ...
                <div className="col-span-1 md:col-span-2">
                    ...
                    <p className="text-gray-400 text-xs font-light max-w-sm leading-relaxed">
                        L'association étudiante de référence pour l'Intelligence Artificielle et la Data Science au sein du réseau Epitech.
                    </p>
                    <div className="mt-4 text-gray-600 text-[10px]">
                        &copy; {currentYear} EPI'AI. All rights reserved.
                    </div>
                </div>

                {/* Navigation */}
                <div className="flex flex-col gap-3">
                    <h4 className="text-white font-bold text-sm mb-1">Navigation</h4>
                    <a href="#home" className="text-gray-400 hover:text-white transition-colors text-xs">Accueil</a>
                    <a href="#team" className="text-gray-400 hover:text-white transition-colors text-xs">Équipe</a>
                    <a href="#projects" className="text-gray-400 hover:text-white transition-colors text-xs">Projets</a>
                    <a href="/blog" className="text-gray-400 hover:text-white transition-colors text-xs">Blog</a>
                </div>

                {/* Socials */}
                <div className="flex flex-col gap-4">
                    <h4 className="text-white font-bold text-sm mb-1">Suivez-nous</h4>
